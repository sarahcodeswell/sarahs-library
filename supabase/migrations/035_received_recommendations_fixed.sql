...
DROP POLICY IF EXISTS "Users can view own received recommendations" ON received_recommendations;
DROP POLICY IF EXISTS "Users can create own received recommendations" ON received_recommendations;
DROP POLICY IF EXISTS "Users can update own received recommendations" ON received_recommendations;
DROP POLICY IF EXISTS "Users can delete own received recommendations" ON received_recommendations;
...
DROP TRIGGER IF EXISTS update_received_recommendations_updated_at ON received_recommendations;
