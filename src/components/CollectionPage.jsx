...
import { ArrowLeft, Search, ShoppingCart, Star, Bookmark } from 'lucide-react';
          ...
          <div className="mb-6 flex flex-wrap gap-1.5 justify-center">
            {availableLetters.map(letter => (
              <button
                ...
                className="w-8 h-8 rounded-lg border border-[#D4DAD0] bg-white hover:bg-[#5F7252] hover:text-white hover:border-[#5F7252] text-[#5F7252] text-xs font-medium transition-colors"
              >
                {letter}
              </button>
            ))}
