...
/**
 * RecommendationActionPanel - Shows side-by-side action buttons after recommendations
 * Option B: Primary "Show Me More" + Secondary "New Search"
 */
...
export default function FormattedRecommendations({ 
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Action buttons: Show Me More + New Search */}
