    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 border border-[#E8EBE4]">
        ...
        <p className="text-sm text-[#7A8F6C] mb-6">
          {mode === 'signin'
            ? 'Sign in to bookmark for future reading and build a personalized reading queue'
            : 'Create a profile to bookmark for future reading and build a personalized reading queue'}
        </p>
        ...
        <div className="mb-6">
          <button
            ...
            type="button"
            className="w-full py-2.5 px-4 border-2 border-[#E8EBE4] rounded-lg hover:bg-[#F8F6EE] transition-colors flex items-center justify-center gap-3 font-medium text-[#4A5940]"
          >
