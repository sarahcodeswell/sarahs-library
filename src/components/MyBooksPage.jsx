      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-[#D4DAD0] bg-white hover:bg-[#F8F6EE] text-[#5F7252] text-sm font-medium transition-colors"
          >
          ...
          <button
            ...
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-[#5F7252] bg-[#5F7252] hover:bg-[#4A5940] text-white text-sm font-medium transition-colors"
          >
        ...
        {isLoadingBooks ? (
          ...
          <div className="text-center py-12">
            ...
            {!searchQuery && (
              <p className="text-[#96A888] text-xs mt-2">Add books manually or take a photo to get started. Mark them as "Read" or "Want to Read" to move them to your reading queue.</p>
            )}
          </div>
        ) : (
