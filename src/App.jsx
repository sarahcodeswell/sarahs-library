...
export default function App() {
  ...
  const [messages, setMessages] = useState([
    { text: "Hi, I'm Sarah!\n\nI'll help you discover your next great read from my curated collection—or discoveries from the world's library, build your personal library, and share recommendations with friends.\n\nTell me what you're in the mood for and I'll find the perfect book for you.", isUser: false }
  ]);
